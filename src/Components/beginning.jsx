    ...
    <section className="beginning-container w-full max-sm:w-screen max-md:w-full md:mt-12">
      <div className="my-8 w-full relative px-10 p-5 max-sm:w-screen max-sm:px-5 max-md:w-[80%]">
        ...
        <div className="flex gap-5">
          ...
          <Button
            color="success"
            className="bg-green-100 hover:bg-green-200 transition-[5s] hover:scale-110 duration-300 ease-in-out rounded-[10px] py-[13px] px-6 text-gray-500"
          >
            Buscar
          </Button>
        </div>
        ...
        {inputValue && (
          <div className="resultados-container md:max-h-[50px] lg:max-h-[200px] max-sm:w-[100%] w-[58.5%] sm:max-h-[30px] mt-5 overflow-y-auto flex flex-wrap justify-around bg-white p-3 px-8 gap-10 border border-green-600">
