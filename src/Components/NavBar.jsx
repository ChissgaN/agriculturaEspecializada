  ...
  return (
    <section className="flex items-center justify-around bg-red-400 h-[100px] gap-5 ">
      ...
      <div className="relative">
        {menuOpen && (
          <div className='border border-gray-300 rounded-tr-none rounded-lg shadow-md p-2 sm:hidden flex bg-red-500 w-[175px] h-[250px] absolute top-[85px]  right-[350px] mx-auto z-10 flex-col place-content-between py-[39px] items-center text-Dark-grayish-blue max-md:text-[22px] after:content-[""] after:absolute after:top-[-24px] after:right-[145px] after:border-[12px] after:border-red-500 after:border-t-transparent after:border-l-transparent tablet:after:hidden tablet:bg-transparent tablet:relative tablet:flex tablet:flex-row tablet:h-full tablet:top-0 tablet:w-[400px] tablet:py-0 sm:text-White lg:w-[490px]'>
